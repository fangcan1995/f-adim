...
export class TreeOptions {
  ...
  get isSelectedField(): string { return this.options.isSelectedField || 'isSelected'}
  get customIconField(): string { return this.options.customIconField || 'customIcon'}
  get forbidChangeTypeField(): string { return this.options.forbidChangeTypeField || 'forbidChangeType'}
