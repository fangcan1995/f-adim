...
export interface ITreeOptions {
  ...
  /**
   * Override isSelected field. Default: 'isSelected'
   */
   isSelectedField?:string;
  /**
   * Override customIcon field. Default: 'customIcon'
   */
   customIconField?:string;
  /**
   * Override forbidChangeType field. Default: 'forbidChangeType'
   */
   forbidChangeTypeField?:string;
   /**
