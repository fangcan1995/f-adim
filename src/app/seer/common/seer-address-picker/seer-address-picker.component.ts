...
export class SeerAddressPickerComponent implements OnInit, OnChanges {
    ...
    ngOnInit() {
        ...
        //     if(this.defaultItemCode!=undefined  && ){
        //         this.initAddress();
    ...
    ngOnChanges() {
        console.log(this.defaultItemCode)
        if(this.defaultItemCode!=undefined){
            this.initAddress();
        }
    }
    ...
    handleProvinceChange($event) {
        this.defaultItemCode = $event.target.value;
        console.log(this.defaultItemCode);
        ...
        this.curCityList = this.getCitys();
        console.log(this.curCityList);
