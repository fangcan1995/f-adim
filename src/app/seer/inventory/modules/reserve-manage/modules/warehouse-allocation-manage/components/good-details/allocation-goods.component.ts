 ...
 */
@Component({
  selector: 'allocation-goods-detail',
  templateUrl: './allocation-goods.component.html',
  styleUrls: ['./allocation-goods.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class AllocationGoodsDialogComponent extends BaseModalComponent implements OnInit{
