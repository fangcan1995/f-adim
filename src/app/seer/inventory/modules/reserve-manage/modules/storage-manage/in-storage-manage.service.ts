...
export class InStorageService {
 ...
 // private addUrl = SERVER+'/inventory/reserve/warehouse/inwarehouserecord/add';
  ...
  private getListUrl = SERVER+'/inventory/reserve/inbound-orders';

  private getOrderDetailUrl =   SERVER+ '/inventory/reserve/inbound-order/';

  private getOrderDetaiListlUrl = SERVER+ '/inventory/reserve/inbound-order-goods';

  private getLinkOrderListlUrl = SERVER+  '/inventory/reserve/inbound-orders';
