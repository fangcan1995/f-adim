...
@Component({
  selector: 'StoragesListComponent',
  templateUrl: './storage-list.component.html',
  styleUrls: ['./storage-list.component.scss'],
  providers: [Ng2Uploader],

})
export class StoragesListComponent extends BaseModalComponent implements OnInit{
  @ViewChild(ModalComponent) modal;
  @ViewChild(SeerTree) seerTree: SeerTree;

  constructor(private repertoryCheckService? :RepertoryCheckService, private gs?:GlobalState){
    super();
  }
  ngOnInit(): void {
  ...
  getStorageId(): void {
    ...
    this.gs.notifyDataChanged('getStorageId',this.permissionsSelected);
